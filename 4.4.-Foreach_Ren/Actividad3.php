<!-- Añadir un intercambiador nuevo-->
<?php
...
// Añadir un nuevo intercambiador
$nuevaEstacion = ['estacion' => 'Príncipe Pío', 'intercambiador' => true];
$estacionesMetroMadrid['Línea 1'][] = $nuevaEstacion;
